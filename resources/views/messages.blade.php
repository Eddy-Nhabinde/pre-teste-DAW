            ...
            <div style="overflow: hidden">
                ...
                <div class="child">
                    <textarea class="form-control" id="exampleFormControlTextarea1"
                        style="box-shadow: none; border: solid black 1px;" placeholder="Escreva Uma Mensagem" rows="3"></textarea>
                        <button class="btn btn-primary" style="margin-left: 10px;height: 50px; margin-right: 10px; margin-top: 15px"><i class="fa-solid fa-paper-plane"></i>Enviar</button>
                </div>
            </div>
        </div>
    </div>
